...
socket.on('join_room_response',function(payload){
	...
	/*If we have seen the person who joined (something weird happened) */
	else{
...
/* What to do when the server has left a room */
...
socket.on('game_update',function(payload){
	...
	console.log('*** Client Log Messages: \'game_update\'\n\tpayload: '+JSON.stringify(payload));
	...
	interval_timer = setInterval(function(last_time){
		return function(){
			//Do the work of updating hte UI
			var d = new Date();
...
socket.on('play_token_response',function(payload){
	...
	console.log('*** Client Log Messages: \'play_token_response\'\n\tpayload: '+JSON.stringify(payload));
...
socket.on('game_over',function(payload){
	...
	console.log('*** Client Log Messages: \'game_over\'\n\tpayload: '+JSON.stringify(payload));
	/* Check for a good play_token_response */
	if(payload.result == 'fail'){
		console.log(payload.message);
		return;
